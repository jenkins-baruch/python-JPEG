...
# print("Split to submatrixes")
# img_channel_y_split = [
#     encode.padding_matrix_to_8_8(matrix)
#     for matrix in encode.split_matrix_into_submatrixs(img_channel_y, 32)
# ]
# img_channel_cr_split = [
#     encode.padding_matrix_to_8_8(matrix)
#     for matrix in encode.split_matrix_into_submatrixs(img_channel_cr, 32)
# ]
# img_channel_cb_split = [
#     encode.padding_matrix_to_8_8(matrix)
#     for matrix in encode.split_matrix_into_submatrixs(img_channel_cb, 32)
# ]

# print("DCT submatrixes")
# img_channel_y_split = [
#     dct.quantization(dct.DCT(submatrix)) for submatrix in img_channel_y_split
# ]
# img_channel_cr_split = [
#     dct.quantization(dct.DCT(submatrix)) for submatrix in img_channel_cr_split
# ]
# img_channel_cb_split = [
#     dct.quantization(dct.DCT(submatrix)) for submatrix in img_channel_cb_split
# ]
...
# imagetools.save_matrix(
#     encode.concatenate_three_colors(img_channel_y_split, img_channel_cr_split,
#                                     img_channel_cb_split),
#     mode='YCrCb',
#     dest=os.path.join(dirname, 'ycrcb_split_dct32.png'))

# print("DCT big image")
# img_matrix_y_dct = dct.inverse_DCT(
#     dct.un_quantization(dct.quantization(dct.DCT(img_channel_y))))
# img_matrix_cr_dct = dct.inverse_DCT(
#     dct.un_quantization(dct.quantization(dct.DCT(img_channel_cr))))
# img_matrix_cb_dct = dct.inverse_DCT(
#     dct.un_quantization(dct.quantization(dct.DCT(img_channel_cb))))

# imagetools.save_matrix(
#     encode.concatenate_three_colors(img_matrix_y_dct, img_matrix_cr_dct,
#                                     img_matrix_cb_dct),
#     mode='YCrCb',
#     dest=os.path.join(dirname, 'ycrcb_dct.png'))
